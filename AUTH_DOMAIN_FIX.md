...
Copy each of these and save them somewhere, or just copy them one by one:
1. `videomaster-ai.tech`
2. `studio-9489287013-59986.web.app`
3. `studio-9489287013-59986.firebaseapp.com`
4. `localhost`
...
4. **Paste** the first domain from the list above.
5. Click **Add**.
6. **Repeat** for all 4 domains.
