...
export default function Dashboard() {
  ...
  const toolSuite = [
    ...
    { label: "Neural Voice", icon: Mic, desc: "Studio Voiceover", color: "text-primary", bg: "bg-primary/10", href: "/editor?tool=ai" },
      ...
      <main className="max-w-[95rem] mx-auto p-6 lg:p-12 space-y-16 pt-32 lg:pt-40">
        ...
        <header className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12 animate-in fade-in slide-in-from-bottom-5 duration-1000">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full glass-panel text-primary text-[10px] font-black uppercase tracking-[0.4em] border-primary/20">
          ...
          <div className="flex items-center gap-8 glass-panel p-8 md:p-12 rounded-[4rem] border-white/5 shadow-2xl relative overflow-hidden group hover:border-primary/20 transition-all">
             ...
             <div className="flex flex-col px-8 border-r border-white/10 relative z-10">
                ...
                <div className="flex items-center gap-5">
                  ...
                  <span className="text-6xl font-bold font-headline text-white tracking-tighter">ELITE</span>
                </div>
             </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center">
           <div className="flex-1 w-full relative group">
              ...
              <input 
                ...
                className="w-full h-20 bg-white/[0.02] border border-white/5 rounded-full px-20 text-xl text-white focus:border-primary/50 transition-all outline-none placeholder:opacity-20 font-medium"
              />
           </div>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {toolSuite.map((tool, i) => (
            <Link key={i} href={tool.href}>
              <Card className="premium-card p-10 group relative overflow-hidden h-full flex flex-col justify-between border-white/5">
                 <div className="absolute -top-10 -right-10 p-10 opacity-[0.02] group-hover:opacity-10 group-hover:scale-150 transition-all duration-1000">
                    <tool.icon size={200} />
                 </div>
                 <div className="space-y-8 relative z-10">
                    <div className={cn("p-6 rounded-[2rem] inline-flex shadow-inner border border-white/5 transition-all group-hover:rotate-12", tool.bg, tool.color)}>
                       <tool.icon size={36} />
                    </div>
                    <div>
                 ...
                 <div className="pt-10 flex items-center justify-between relative z-10">
                    <div className="h-1 flex-1 bg-white/5 rounded-full overflow-hidden mr-6">
                       <div className={cn("h-full w-0 group-hover:w-full transition-all duration-1000 bg-primary")} />
                    </div>
        ...
        <section className="grid lg:grid-cols-3 gap-12">
           <Card className="lg:col-span-2 premium-card p-12 space-y-12 relative overflow-hidden border-white/5">
              ...
              <div className="flex items-center justify-between border-b border-white/5 pb-10 relative z-10">
                 ...
                 <Link href="/projects" className="px-6 py-2.5 rounded-full border border-white/10 text-[10px] font-black uppercase tracking-widest text-white hover:bg-white/5 transition-all">View Repository</Link>
              </div>
           ...
           <div className="space-y-12">
              <Card className="glass-panel p-12 rounded-[4rem] border-white/5 space-y-10 relative overflow-hidden group hover:border-primary/20 transition-all">
                 <div className="absolute top-0 right-0 p-10 opacity-[0.02] group-hover:opacity-5 transition-all duration-1000">
                 ...
                 <div className="space-y-4 relative z-10">
                    ...
                    <p className="text-lg text-muted-foreground italic leading-relaxed opacity-60">AI-powered trend analysis for high-value engagement.</p>
                 </div>
                 <Button className="w-full h-20 rounded-full bg-white text-black hover:bg-primary transition-all font-black text-xs uppercase tracking-widest shadow-2xl relative z-10" asChild>
                    <Link href="/ai-assistant">Launch Protocol</Link>
                 </Button>
              </Card>

              <Card className="glass-panel p-12 rounded-[4rem] border-white/5 space-y-8 relative overflow-hidden group hover:border-white/20 transition-all">
                 <div className="flex items-center gap-5">
                 ...
                 <p className="text-base text-muted-foreground italic leading-relaxed opacity-60">Access professional frameworks for global dominance.</p>
                 <Button className="w-full h-16 rounded-full bg-black/40 border border-white/10 text-white font-black text-[10px] uppercase tracking-widest transition-all hover:bg-white/5" asChild>
