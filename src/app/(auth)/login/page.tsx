  ...
  return (
    <CardContent className="space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-[10px] uppercase font-black text-muted-foreground tracking-[0.3em]"><span className="bg-[#0a0d14] px-4">OR USE EMAIL</span></div>
      </div>
      ...
      <div className="w-full max-w-md animate-in fade-in duration-500 space-y-6">
        <Card className="border-white/5 bg-[#0a0d14] rounded-[2.5rem] shadow-2xl overflow-hidden border-t-primary/20 border-t-2">
          <CardHeader className="text-center pt-8 pb-4">
            ...
            <CardTitle className="text-2xl font-bold font-headline text-white">Login to Studio</CardTitle>
            <CardDescription className="italic text-muted-foreground">Access your AI tools instantly</CardDescription>
          </CardHeader>
