            ...
            <div className="p-5 bg-red-500/10 border border-red-500/30 rounded-2xl space-y-4 animate-in zoom-in-95">
              <div className="flex gap-3">
                ...
                <div className="space-y-1">
                  <p className="text-[10px] font-bold text-red-500 uppercase tracking-widest text-left">Configuration Fix Required</p>
                  <p className="text-[11px] text-white/70 text-left">Please copy the domain below and add it to your Firebase Console:</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-2">
                <Button className="w-full h-10 rounded-xl bg-red-600 font-bold text-[10px] uppercase tracking-wider" asChild>
                  <a href="https://console.firebase.google.com/project/studio-9489287013-59986/authentication/settings" target="_blank">
                    Open Firebase Auth Settings <ExternalLink className="ml-2 w-3 h-3" />
                  </a>
                </Button>
              </div>
            </div>
