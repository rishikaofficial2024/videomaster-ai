 ...
 * 
 * ✅ STATUS: CONNECTED TO FREE GOOGLE DOMAIN
 * authDomain is set to the default firebaseapp.com to ensure 100% login success 
 * without needing to pay for a custom domain.
 */
